...
most_hwy <- function(year_choice, make_choice) {
  years_vehicles <- vehicles[vehicles$year == year_choice, ]
  make_year_vehicles <- years_vehicles[years_vehicles$make == make_choice, ]
  make_year_vehicles[make_year_vehicles$hwy == max(make_year_vehicles$hwy), "model"]
}
